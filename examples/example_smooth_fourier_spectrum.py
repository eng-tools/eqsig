...
def create():
    ...
    smatrix = eqsig.calc_smoothing_matrix_konno_1998(asig.fa_freqs, smooth_fa_frequencies=asig.smooth_fa_freqs, band=40)
    sps[1].loglog(asig.smooth_fa_freqs, eqsig.calc_smooth_fa_spectrum_w_custom_matrix(asig, smatrix), c='m',
